...
object KeyCode {
    ...
    const val SECURE_COMPOSER =           -10052
    const val SECURE_DECRYPT =            -10053
    // Intents
    ...
    fun Int.checkAndConvertCode(): Int = if (this > 0) this else when (this) {
        ...
        SEND_INTENT_THREE, EMOJI_SEARCH, INLINE_EMOJI_SEARCH_DONE, META_LOCK, SECURE_COMPOSER, SECURE_DECRYPT
        -> this
